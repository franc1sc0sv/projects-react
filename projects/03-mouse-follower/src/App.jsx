...
const FollowMouse = () => {
  // Usar document en el cuerpo de la funcion es mala practica
  ...
  useEffect(() => {
    document.body.classList.toggle('cursor-none', enable)
    return () => { document.body.classList.toggle('cursor-default', enable) }
  }, [enable])
